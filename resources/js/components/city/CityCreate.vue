<template>
    ...
    <form class="space-y-6" @submit.prevent="saveCity">
        <div class="space-y-4 rounded-md shadow-sm">
            <div>
                <label for="country" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Country</label>
                <select id="country" v-model="form.country_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
export default {
    setup() {
        ...
        const { errors, storeCity } = useCity()
